...
def compute_lookat_matrix(
    ...
    camera_to_world = math_utils.homogenize_matrices(camera_to_world)
...
@jaxtyped
@typechecked
def sample_location_on_sphere(radius: float) -> Float[Tensor, "3"]:
    ...
    position = convert_spherical_to_cartesian(radius, azimuth, elevation)

...
A script for testing the renderer by rendering Stanford Bunny.
"""
...
@jaxtyped
@typechecked
def render_bunny(out_dir: Path, device: torch.device) -> None:
    """A test cases that loads and renders Stanford Bunny"""

    # load mesh
    data_dir = Path(__file__).parents[2] / "data/renderer/bunny"
    path = data_dir / "stanford-bunny.obj"

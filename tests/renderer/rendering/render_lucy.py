...
A script for testing the renderer by rendering Lucy.
"""
...
@jaxtyped
@typechecked
def render_lucy(out_dir: Path, device: torch.device) -> None:
    """A test cases that loads and renders Lucy"""

    # load mesh
    data_dir = Path(__file__).parents[2] / "data/renderer/lucy"
    path = data_dir / "lucy.obj"
